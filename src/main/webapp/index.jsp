        ...
        <div class="card-container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor sit consectetuasafsdr elit.</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Sailaja ipsum dolor1aaasdadasdad sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Haha Mulan dolohi sdfa fa sdfadf ar sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor sisft geadafadllo consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor si1t consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor sit hi we are editing consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor sit consectetur hi i amelit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor sit ssdfa consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Lorem ipsum dolor hi we are testing it sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Dil Bechara</h2>
                    <h6 class="des">Lorem ipsum dolor sit hi consectetur elisdfsfdgdfgt.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
        </div>
